...
-ol , Tag Html "ol" mendefinisikan daftar yang diurutkan. List yang diurutkan dimulai dengan tag "ol". Setiap item daftar dimulai dengan "li" tag.
...
Output 2: Setelah gambar di klik dan gambar berubah.
